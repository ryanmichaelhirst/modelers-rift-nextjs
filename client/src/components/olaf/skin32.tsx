...
export default function Model(props: JSX.IntrinsicElements['group'] & { glb: any; timerLabel: string }) {
  ...
  return (
    <group ref={ref} {...props} dispose={null}>
      ...
      <skinnedMesh geometry={nodes.mesh_0.geometry} material={materials.Hair} skeleton={nodes.mesh_0.skeleton} />
      ...
      <skinnedMesh geometry={nodes.mesh_0_4.geometry} material={materials.Veigo01} skeleton={nodes.mesh_0_4.skeleton} />
    </group>
  )
}
