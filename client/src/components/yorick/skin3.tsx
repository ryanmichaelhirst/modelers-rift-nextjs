  ...
  return (
    <group ref={ref} {...props} dispose={null}>
      <group scale={[-1, 1, 1]}>
        ...
        <primitive object={nodes.Root_Wraith} />
      </group>
      ...
      />
      <skinnedMesh geometry={nodes.mesh_0_2.geometry} material={materials.Wraith} skeleton={nodes.mesh_0_2.skeleton} />
    </group>
  )
}
