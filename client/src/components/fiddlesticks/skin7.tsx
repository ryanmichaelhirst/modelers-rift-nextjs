...
type GLTFResult = GLTF & {
  nodes: {
    ...
    Recall_Present1: THREE.Bone
    Recall_Present2: THREE.Bone
    Recall_Present3: THREE.Bone
  }
  materials: {
...
type ActionName =
  ...
  | 'fiddlesticks_skin07_spell4_run.fiddlesticksrework'
  ...
  | 'fiddlesticks_skin07_spell3_mid.fiddlesticksrework'
  | 'fiddlesticks_skin07_spell3_short.fiddlesticksrework'
  | 'fiddlesticks_skin07_spell4_nomove.fiddlesticksrework'
  | 'Respawn'
  ...
  | 'fiddlesticks_skin07_spell4_nomove_toidle.fiddlesticksrework'
  | 'Run_In'
  | 'Crit_ToIdle'
  | 'Dance_Loop'
  | 'Joke'
  ...
  return (
    <group ref={ref} {...props} dispose={null}>
      <group scale={[-1, 1, 1]}>
        ...
        <primitive object={nodes.Recall_Present1} />
      ...
      <skinnedMesh geometry={nodes.mesh_0_1.geometry} material={materials.Lantern} skeleton={nodes.mesh_0_1.skeleton} />
      ...
      />
      <skinnedMesh geometry={nodes.mesh_0_6.geometry} material={materials.Poro} skeleton={nodes.mesh_0_6.skeleton} />
      <skinnedMesh geometry={nodes.mesh_0_7.geometry} material={materials.Present} skeleton={nodes.mesh_0_7.skeleton} />
    </group>
  )
}
