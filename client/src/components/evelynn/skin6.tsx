...
type GLTFResult = GLTF & {
  ...
  materials: {
    ...
    Lasher_Tips: THREE.MeshBasicMaterial
    Glasses: THREE.MeshBasicMaterial
    Evelynn_Skin06_Lashers: THREE.MeshBasicMaterial
  }
}
