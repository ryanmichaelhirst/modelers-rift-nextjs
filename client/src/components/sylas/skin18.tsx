...
export default function Model(props: JSX.IntrinsicElements['group'] & { glb: any; timerLabel: string }) {
  ...
  return (
    <group ref={ref} {...props} dispose={null}>
      ...
      <skinnedMesh geometry={nodes.mesh_0_1.geometry} material={materials.Chain_R} skeleton={nodes.mesh_0_1.skeleton} />
      <skinnedMesh geometry={nodes.mesh_0_2.geometry} material={materials.Chain_L} skeleton={nodes.mesh_0_2.skeleton} />
      ...
      />
      <skinnedMesh geometry={nodes.mesh_0_6.geometry} material={materials.Lock} skeleton={nodes.mesh_0_6.skeleton} />
      <skinnedMesh
