...
type GLTFResult = GLTF & {
  ...
  materials: {
    ...
    Skin09_Recall_Flower: THREE.MeshBasicMaterial
    Skin09_Wing: THREE.MeshBasicMaterial
...
export default function Model(props: JSX.IntrinsicElements['group'] & { glb: any; timerLabel: string }) {
  ...
  return (
    <group ref={ref} {...props} dispose={null}>
      ...
      <skinnedMesh geometry={nodes.mesh_0.geometry} material={materials.Skin09_Mat} skeleton={nodes.mesh_0.skeleton} />
      <skinnedMesh
      ...
      <skinnedMesh
        ...
        material={materials.Skin09_Recall_Flower}
        skeleton={nodes.mesh_0_2.skeleton}
      />
      <skinnedMesh
        geometry={nodes.mesh_0_3.geometry}
        material={materials.Skin09_Wing}
        skeleton={nodes.mesh_0_3.skeleton}
      />
      <skinnedMesh geometry={nodes.mesh_0_4.geometry} material={materials.Honey} skeleton={nodes.mesh_0_4.skeleton} />
    </group>
  )
}
