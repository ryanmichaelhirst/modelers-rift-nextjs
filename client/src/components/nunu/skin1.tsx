...
type GLTFResult = GLTF & {
  ...
  materials: {
    Nunu_Sasquatch_Mat: THREE.MeshBasicMaterial
  ...
  return (
    <group ref={ref} {...props} dispose={null}>
      ...
      <skinnedMesh
        ...
        material={materials.Nunu_Sasquatch_Mat}
      ...
      <skinnedMesh geometry={nodes.mesh_0_3.geometry} material={materials.snowman} skeleton={nodes.mesh_0_3.skeleton} />
    </group>
  )
}
