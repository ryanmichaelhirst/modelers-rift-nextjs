...
type GLTFResult = GLTF & {
  ...
  materials: {
    Nunu_Skin05_Mat: THREE.MeshBasicMaterial
    flute: THREE.MeshBasicMaterial
    NunuCapesFix_Nunu_Skin05_Mat: THREE.MeshBasicMaterial
    willump: THREE.MeshBasicMaterial
    claws_long: THREE.MeshBasicMaterial
    claws_short: THREE.MeshBasicMaterial
  ...
  return (
    <group ref={ref} {...props} dispose={null}>
      ...
      <skinnedMesh
        ...
        material={materials.Nunu_Skin05_Mat}
        skeleton={nodes.mesh_0.skeleton}
      />
      <skinnedMesh geometry={nodes.mesh_0_1.geometry} material={materials.flute} skeleton={nodes.mesh_0_1.skeleton} />
      <skinnedMesh
        geometry={nodes.mesh_0_2.geometry}
        material={materials.NunuCapesFix_Nunu_Skin05_Mat}
        skeleton={nodes.mesh_0_2.skeleton}
      />
      <skinnedMesh geometry={nodes.mesh_0_3.geometry} material={materials.willump} skeleton={nodes.mesh_0_3.skeleton} />
      <skinnedMesh
      ...
      />
      <skinnedMesh geometry={nodes.mesh_0_6.geometry} material={materials.snowman} skeleton={nodes.mesh_0_6.skeleton} />
    </group>
  )
}
