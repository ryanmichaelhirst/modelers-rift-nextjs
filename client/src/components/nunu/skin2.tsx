...
type GLTFResult = GLTF & {
  ...
  materials: {
    Nunu_Skin02_Mat: THREE.MeshBasicMaterial
    flute: THREE.MeshBasicMaterial
    willump: THREE.MeshBasicMaterial
    glownose: THREE.MeshBasicMaterial
  ...
  return (
    <group ref={ref} {...props} dispose={null}>
      ...
      <skinnedMesh
        ...
        material={materials.Nunu_Skin02_Mat}
      ...
      <skinnedMesh
        ...
        material={materials.glownose}
        skeleton={nodes.mesh_0_3.skeleton}
      />
      <skinnedMesh geometry={nodes.mesh_0_4.geometry} material={materials.snowman} skeleton={nodes.mesh_0_4.skeleton} />
    </group>
  )
}
