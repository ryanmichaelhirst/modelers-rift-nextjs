...
type GLTFResult = GLTF & {
  ...
  materials: {
    ...
    wheels: THREE.MeshBasicMaterial
    tail_recall: THREE.MeshBasicMaterial
...
export default function Model(props: JSX.IntrinsicElements['group'] & { glb: any; timerLabel: string }) {
  ...
  return (
    <group ref={ref} {...props} dispose={null}>
      ...
      />
      <skinnedMesh geometry={nodes.mesh_0_1.geometry} material={materials.willump} skeleton={nodes.mesh_0_1.skeleton} />
      <skinnedMesh geometry={nodes.mesh_0_2.geometry} material={materials.screen} skeleton={nodes.mesh_0_2.skeleton} />
      <skinnedMesh
      ...
      <skinnedMesh geometry={nodes.mesh_0_5.geometry} material={materials.wheels} skeleton={nodes.mesh_0_5.skeleton} />
      <skinnedMesh
      ...
      <skinnedMesh geometry={nodes.mesh_0_8.geometry} material={materials.tail} skeleton={nodes.mesh_0_8.skeleton} />
      <skinnedMesh geometry={nodes.mesh_0_9.geometry} material={materials.snowman} skeleton={nodes.mesh_0_9.skeleton} />
    </group>
  )
}
