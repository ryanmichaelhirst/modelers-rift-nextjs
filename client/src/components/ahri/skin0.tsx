...
import ahri from '@assets/ahri/skin0.glb'
...
export default function Model(props: JSX.IntrinsicElements['group']) {
  ...
  const { nodes, materials, animations } = useGLTF(ahri) as GLTFResult
  useCycleAnimations<GLTFActions>({
    animations,
    ref,
    timerLabel: 'ahri',
    baseMaterial: materials.Ahri_Skin04_Mat,
  })
