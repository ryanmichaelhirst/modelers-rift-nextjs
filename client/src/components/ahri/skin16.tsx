...
type GLTFResult = GLTF & {
  ...
  materials: {
    Ahri_Skin16_MAT: THREE.MeshBasicMaterial
    Gold: THREE.MeshBasicMaterial
    Ahri_Skin16_Tails_MAT: THREE.MeshBasicMaterial
  }
}
