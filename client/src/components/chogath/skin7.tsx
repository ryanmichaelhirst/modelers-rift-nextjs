...
export default function Model(props: JSX.IntrinsicElements['group'] & { glb: any; timerLabel: string }) {
  ...
  return (
    <group ref={ref} {...props} dispose={null}>
      ...
      <skinnedMesh geometry={nodes.mesh_0.geometry} material={materials.Body_Tier1} skeleton={nodes.mesh_0.skeleton} />
      <skinnedMesh
      ...
      />
      <skinnedMesh geometry={nodes.mesh_0_3.geometry} material={materials.Meteo} skeleton={nodes.mesh_0_3.skeleton} />
