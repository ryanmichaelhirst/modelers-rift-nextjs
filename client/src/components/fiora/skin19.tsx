...
type GLTFResult = GLTF & {
  ...
  materials: {
    ...
    Fiora_PoolParty_MAT2: THREE.MeshBasicMaterial
    Fiora_PoolParty_MAT: THREE.MeshBasicMaterial
  ...
  return (
    <group ref={ref} {...props} dispose={null}>
      ...
      <skinnedMesh
        ...
        material={materials.Fiora_PoolParty_MAT2}
        skeleton={nodes.mesh_0_1.skeleton}
      />
      <skinnedMesh
        geometry={nodes.mesh_0_2.geometry}
        material={materials.Fiora_PoolParty_MAT}
