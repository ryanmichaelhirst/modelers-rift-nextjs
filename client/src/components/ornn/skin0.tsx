...
type GLTFResult = GLTF & {
  ...
  materials: {
    Ornn_Base_Mat: THREE.MeshBasicMaterial
    Ornn_Base_Anvil_Mat: THREE.MeshBasicMaterial
    Ornn_Base_Hammer_Mat: THREE.MeshBasicMaterial
    Ornn_Base_Sword_Mat: THREE.MeshBasicMaterial
    Ornn_Base_Bucket_Mat: THREE.MeshBasicMaterial
  ...
  return (
    <group ref={ref} {...props} dispose={null}>
      ...
      <skinnedMesh
        ...
        material={materials.Ornn_Base_Mat}
        skeleton={nodes.mesh_0.skeleton}
      />
      <skinnedMesh
        geometry={nodes.mesh_0_1.geometry}
        material={materials.Ornn_Base_Anvil_Mat}
        skeleton={nodes.mesh_0_1.skeleton}
      />
      <skinnedMesh
        geometry={nodes.mesh_0_2.geometry}
        material={materials.Ornn_Base_Hammer_Mat}
        skeleton={nodes.mesh_0_2.skeleton}
      />
      <skinnedMesh
        geometry={nodes.mesh_0_3.geometry}
        material={materials.Ornn_Base_Sword_Mat}
        skeleton={nodes.mesh_0_3.skeleton}
      />
      <skinnedMesh
        geometry={nodes.mesh_0_4.geometry}
        material={materials.Ornn_Base_Bucket_Mat}
