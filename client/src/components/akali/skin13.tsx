...
type GLTFResult = GLTF & {
  ...
  materials: {
    ...
    Akali_Skin13_Hair_Mat: THREE.MeshBasicMaterial
...
export default function Model(props: JSX.IntrinsicElements['group'] & { glb: any; timerLabel: string }) {
  ...
  return (
    <group ref={ref} {...props} dispose={null}>
      ...
      />
      <skinnedMesh geometry={nodes.mesh_0_1.geometry} material={materials.Gold} skeleton={nodes.mesh_0_1.skeleton} />
      <skinnedMesh
        geometry={nodes.mesh_0_2.geometry}
        material={materials.Akali_Skin13_Hair_Mat}
      ...
      />
      <skinnedMesh geometry={nodes.mesh_0_7.geometry} material={materials.Mask} skeleton={nodes.mesh_0_7.skeleton} />
