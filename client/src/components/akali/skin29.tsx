...
type GLTFResult = GLTF & {
  nodes: {
    ...
    L_Hand_TrailBuffBone: THREE.Bone
    R_Hand_TrailBuffBone: THREE.Bone
    Recall_Mask_Main: THREE.Bone
  }
  materials: {
    Akali_Skin15_MAT: THREE.MeshBasicMaterial
    Akali_Skin15_DefaultMask_MAT: THREE.MeshBasicMaterial
    Akali_Skin15_MaskOnFace_MAT: THREE.MeshBasicMaterial
    ...
    Akali_Skin15_RecallMask_MAT: THREE.MeshBasicMaterial
  }
}
  ...
  return (
    <group ref={ref} {...props} dispose={null}>
      <group scale={[-1, 1, 1]}>
        ...
        <primitive object={nodes.L_Hand_TrailBuffBone} />
        <primitive object={nodes.R_Hand_TrailBuffBone} />
        <primitive object={nodes.Recall_Mask_Main} />
      </group>
      <skinnedMesh
        geometry={nodes.mesh_0.geometry}
        material={materials.Akali_Skin15_MAT}
        skeleton={nodes.mesh_0.skeleton}
      />
      <skinnedMesh
        geometry={nodes.mesh_0_1.geometry}
        material={materials.Akali_Skin15_DefaultMask_MAT}
        skeleton={nodes.mesh_0_1.skeleton}
      />
      <skinnedMesh
        geometry={nodes.mesh_0_2.geometry}
        material={materials.Akali_Skin15_MaskOnFace_MAT}
      ...
      />
      <skinnedMesh geometry={nodes.mesh_0_9.geometry} material={materials.ramen} skeleton={nodes.mesh_0_9.skeleton} />
      <skinnedMesh
      ...
      <skinnedMesh
        ...
        material={materials.Akali_Skin15_RecallMask_MAT}
