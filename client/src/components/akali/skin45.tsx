...
type GLTFResult = GLTF & {
  nodes: {
    ...
    Cstm_Buffbone_VFX_1: THREE.Bone
    LightColumn1: THREE.Bone
    LightColumn2: THREE.Bone
    LightColumn3: THREE.Bone
    LightColumn4: THREE.Bone
    LightColumn5: THREE.Bone
    Platform: THREE.Bone
  }
  materials: {
    Body: THREE.MeshBasicMaterial
    Hair_Bangs: THREE.MeshBasicMaterial
  ...
  return (
    <group ref={ref} {...props} dispose={null}>
      <group scale={[-1, 1, 1]}>
        ...
        <primitive object={nodes.Cstm_Buffbone_VFX_1} />
        <primitive object={nodes.LightColumn1} />
        <primitive object={nodes.LightColumn2} />
        <primitive object={nodes.LightColumn3} />
        <primitive object={nodes.LightColumn4} />
        <primitive object={nodes.LightColumn5} />
        <primitive object={nodes.Platform} />
      </group>
      <skinnedMesh geometry={nodes.mesh_0.geometry} material={materials.Body} skeleton={nodes.mesh_0.skeleton} />
      <skinnedMesh
        geometry={nodes.mesh_0_1.geometry}
        material={materials.Hair_Bangs}
      ...
      />
      <skinnedMesh geometry={nodes.mesh_0_6.geometry} material={materials.ramen} skeleton={nodes.mesh_0_6.skeleton} />
      <skinnedMesh
      ...
      />
      <skinnedMesh geometry={nodes.mesh_0_9.geometry} material={materials.Helmet} skeleton={nodes.mesh_0_9.skeleton} />
      <skinnedMesh
        geometry={nodes.mesh_0_10.geometry}
        material={materials.Lights}
        skeleton={nodes.mesh_0_10.skeleton}
      />
      <skinnedMesh geometry={nodes.mesh_0_11.geometry} material={materials.Stage} skeleton={nodes.mesh_0_11.skeleton} />
    </group>
  )
}
