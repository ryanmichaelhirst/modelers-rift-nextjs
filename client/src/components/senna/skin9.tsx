...
type GLTFResult = GLTF & {
  ...
  materials: {
    ...
    Senna_Skin09_Jacket_Mat: THREE.MeshBasicMaterial
    Senna_Skin09_Pants_Mat: THREE.MeshBasicMaterial
    Senna_Skin09_Hair_Mat: THREE.MeshBasicMaterial
    Cloak: THREE.MeshBasicMaterial
    Glasses_Mat: THREE.MeshBasicMaterial
  ...
  return (
    <group ref={ref} {...props} dispose={null}>
      ...
      <skinnedMesh
        ...
        material={materials.Senna_Skin09_Jacket_Mat}
        skeleton={nodes.mesh_0_1.skeleton}
      />
      <skinnedMesh
        geometry={nodes.mesh_0_2.geometry}
        material={materials.Senna_Skin09_Pants_Mat}
        skeleton={nodes.mesh_0_2.skeleton}
      />
      <skinnedMesh
        geometry={nodes.mesh_0_3.geometry}
        material={materials.Senna_Skin09_Hair_Mat}
        skeleton={nodes.mesh_0_3.skeleton}
      />
      <skinnedMesh geometry={nodes.mesh_0_4.geometry} material={materials.Cloak} skeleton={nodes.mesh_0_4.skeleton} />
      <skinnedMesh
        geometry={nodes.mesh_0_5.geometry}
        material={materials.Glasses_Mat}
