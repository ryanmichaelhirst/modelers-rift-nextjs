...
type GLTFResult = GLTF & {
  nodes: {
    ...
    Pengu_Buffbone_Glb_Ground_Loc: THREE.Bone
    Pengu_C_Buffbone_Glb_Overhead_Loc: THREE.Bone
    Reacll_VFX_jnt3_Loc: THREE.Bone
    Reacll_VFX_jnt2_Loc: THREE.Bone
    Reacll_VFX_jnt1_Loc: THREE.Bone
  }
  materials: {
    Gun_AfterImage: THREE.MeshBasicMaterial
    Body: THREE.MeshBasicMaterial
    VFXCloak: THREE.MeshBasicMaterial
    VFX_Arm: THREE.MeshBasicMaterial
    VFX_Body: THREE.MeshBasicMaterial
    VFXRibbon: THREE.MeshBasicMaterial
  ...
  return (
    <group ref={ref} {...props} dispose={null}>
      <group scale={[-1, 1, 1]}>
        ...
        <primitive object={nodes.Pengu_Buffbone_Glb_Ground_Loc} />
        <primitive object={nodes.Pengu_C_Buffbone_Glb_Overhead_Loc} />
        <primitive object={nodes.Reacll_VFX_jnt3_Loc} />
        <primitive object={nodes.Reacll_VFX_jnt2_Loc} />
        <primitive object={nodes.Reacll_VFX_jnt1_Loc} />
      </group>
      <skinnedMesh
      ...
      <skinnedMesh
        ...
        material={materials.VFXCloak}
        skeleton={nodes.mesh_0_2.skeleton}
      />
      <skinnedMesh geometry={nodes.mesh_0_3.geometry} material={materials.VFX_Arm} skeleton={nodes.mesh_0_3.skeleton} />
      <skinnedMesh
