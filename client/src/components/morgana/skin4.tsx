...
type GLTFResult = GLTF & {
  ...
  materials: {
    Morgana_Skin04_Body_Mat: THREE.MeshBasicMaterial
  ...
  return (
    <group ref={ref} {...props} dispose={null}>
      <group scale={[-1, 1, 1]}>
        ...
        <primitive object={nodes.Vine_1} />
        <primitive object={nodes.Apple} />
      ...
      <skinnedMesh
        ...
        material={materials.Morgana_Skin04_Body_Mat}
      ...
      <skinnedMesh geometry={nodes.mesh_0_5.geometry} material={materials.flower} skeleton={nodes.mesh_0_5.skeleton} />
    </group>
  )
}
