...
export default function Model(props: JSX.IntrinsicElements['group'] & { glb: any; timerLabel: string }) {
  ...
  return (
    <group ref={ref} {...props} dispose={null}>
      ...
      />
      <skinnedMesh geometry={nodes.mesh_0_4.geometry} material={materials.Sun_Mat} skeleton={nodes.mesh_0_4.skeleton} />
      <skinnedMesh
      ...
      />
      <skinnedMesh geometry={nodes.mesh_0_7.geometry} material={materials.Hair} skeleton={nodes.mesh_0_7.skeleton} />
    </group>
  )
}
