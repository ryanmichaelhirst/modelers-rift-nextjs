...
type ActionName =
  ...
  | 'leblanc_skin33_idle_alt.pie_c_11_16'
  | 'leblanc_skin33_idle1_alt_in.pie_c_11_16'
  | 'Spin'
  | 'Recall_Winddown'
...
export default function Model(props: JSX.IntrinsicElements['group'] & { glb: any; timerLabel: string }) {
  ...
  return (
    <group ref={ref} {...props} dispose={null}>
      ...
      />
      <skinnedMesh geometry={nodes.mesh_0_4.geometry} material={materials.Mirror} skeleton={nodes.mesh_0_4.skeleton} />
      <skinnedMesh
