...
type GLTFResult = GLTF & {
  nodes: {
    ...
    Bowl: THREE.Bone
    Flower: THREE.Bone
    Scarf_Recall1: THREE.Bone
  }
  materials: {
    Aphelios_Base_Mat: THREE.MeshBasicMaterial
    scarf: THREE.MeshBasicMaterial
    recall: THREE.MeshBasicMaterial
    flower: THREE.MeshBasicMaterial
    scarf_recall: THREE.MeshBasicMaterial
  ...
  return (
    <group ref={ref} {...props} dispose={null}>
      <group scale={[-1, 1, 1]}>
        ...
        <primitive object={nodes.Scarf_Recall1} />
      </group>
      <skinnedMesh
        geometry={nodes.mesh_0.geometry}
        material={materials.Aphelios_Base_Mat}
      ...
      <skinnedMesh geometry={nodes.mesh_0_3.geometry} material={materials.flower} skeleton={nodes.mesh_0_3.skeleton} />
      <skinnedMesh
        geometry={nodes.mesh_0_4.geometry}
        material={materials.scarf_recall}
      ...
      />
      <skinnedMesh geometry={nodes.mesh_0_9.geometry} material={materials.severum} skeleton={nodes.mesh_0_9.skeleton} />
    </group>
  )
}
