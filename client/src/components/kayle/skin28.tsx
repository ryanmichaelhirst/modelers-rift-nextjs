...
type GLTFResult = GLTF & {
  ...
  materials: {
    ...
    HeadDragon: THREE.MeshBasicMaterial
  }
}
  ...
  return (
    <group ref={ref} {...props} dispose={null}>
      <group scale={[-1, 1, 1]}>
        ...
        <primitive object={nodes.HeadDragon} />
      </group>
      <skinnedMesh geometry={nodes.mesh_0.geometry} material={materials.level1} skeleton={nodes.mesh_0.skeleton} />
      <skinnedMesh geometry={nodes.mesh_0_1.geometry} material={materials.level11} skeleton={nodes.mesh_0_1.skeleton} />
      <skinnedMesh
