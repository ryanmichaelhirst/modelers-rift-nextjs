...
type GLTFResult = GLTF & {
  ...
  materials: {
    Kayle_Skin08_Body_Mat: THREE.MeshBasicMaterial
  ...
  return (
    <group ref={ref} {...props} dispose={null}>
      ...
      <skinnedMesh
        ...
        material={materials.Kayle_Skin08_Body_Mat}
        skeleton={nodes.mesh_0.skeleton}
      />
      <skinnedMesh geometry={nodes.mesh_0_1.geometry} material={materials.level11} skeleton={nodes.mesh_0_1.skeleton} />
      <skinnedMesh geometry={nodes.mesh_0_2.geometry} material={materials.level1} skeleton={nodes.mesh_0_2.skeleton} />
      <skinnedMesh
