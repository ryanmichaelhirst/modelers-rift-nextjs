...
type GLTFResult = GLTF & {
  nodes: {
    ...
    Soccer_Ball: THREE.Bone
    Soccer_Net_Root: THREE.Bone
    SnapPole2World: THREE.Bone
  }
  materials: {
  ...
  return (
    <group ref={ref} {...props} dispose={null}>
      <group scale={[-1, 1, 1]}>
        ...
        <primitive object={nodes.Soccer_Ball} />
        <primitive object={nodes.Soccer_Net_Root} />
        <primitive object={nodes.SnapPole2World} />
      </group>
      <skinnedMesh geometry={nodes.mesh_0.geometry} material={materials.Skin08_Mat} skeleton={nodes.mesh_0.skeleton} />
      <skinnedMesh
