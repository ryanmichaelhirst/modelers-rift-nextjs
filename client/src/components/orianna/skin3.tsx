...
type GLTFResult = GLTF & {
  ...
  materials: {
    Orianna: THREE.MeshBasicMaterial
...
export default function Model(props: JSX.IntrinsicElements['group'] & { glb: any; timerLabel: string }) {
  ...
  return (
    <group ref={ref} {...props} dispose={null}>
      ...
      <skinnedMesh geometry={nodes.mesh_0.geometry} material={materials.Orianna} skeleton={nodes.mesh_0.skeleton} />
      <skinnedMesh geometry={nodes.mesh_0_1.geometry} material={materials.Ball} skeleton={nodes.mesh_0_1.skeleton} />
    </group>
  )
}
