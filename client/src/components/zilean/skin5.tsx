...
type GLTFResult = GLTF & {
  nodes: {
    ...
    R_Drumstick: THREE.Bone
    L_Drumstick: THREE.Bone
  }
  materials: {
  ...
  return (
    <group ref={ref} {...props} dispose={null}>
      <group scale={[-1, 1, 1]}>
        ...
        <primitive object={nodes.R_Drumstick} />
        <primitive object={nodes.L_Drumstick} />
      </group>
      <skinnedMesh geometry={nodes.mesh_0.geometry} material={materials.lambert23} skeleton={nodes.mesh_0.skeleton} />
