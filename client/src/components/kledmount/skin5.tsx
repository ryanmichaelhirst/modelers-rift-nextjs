  ...
  return (
    <group ref={ref} {...props} dispose={null}>
      <group scale={[-1, 1, 1]}>
        ...
        <primitive object={nodes.PumpkinUlt} />
      </group>
      <skinnedMesh
      ...
      />
      <skinnedMesh geometry={nodes.mesh_0_2.geometry} material={materials.Pumpkin} skeleton={nodes.mesh_0_2.skeleton} />
    </group>
  )
}
