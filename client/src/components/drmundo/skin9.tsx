...
type GLTFResult = GLTF & {
  nodes: {
    ...
    Recall_Chair_Root: THREE.Bone
    Recall_ChairUlt_Root: THREE.Bone
  }
  materials: {
...
export default function Model(props: JSX.IntrinsicElements['group'] & { glb: any; timerLabel: string }) {
  ...
  return (
    <group ref={ref} {...props} dispose={null}>
      ...
      />
      <skinnedMesh geometry={nodes.mesh_0_8.geometry} material={materials.BodyUlt} skeleton={nodes.mesh_0_8.skeleton} />
      <skinnedMesh
        geometry={nodes.mesh_0_9.geometry}
        material={materials.R_Capacitor}
        skeleton={nodes.mesh_0_9.skeleton}
      />
      <skinnedMesh geometry={nodes.mesh_0_10.geometry} material={materials.Bag} skeleton={nodes.mesh_0_10.skeleton} />
      <skinnedMesh
        geometry={nodes.mesh_0_11.geometry}
        material={materials.Ladder}
        skeleton={nodes.mesh_0_11.skeleton}
      />
      <skinnedMesh geometry={nodes.mesh_0_12.geometry} material={materials.Stick} skeleton={nodes.mesh_0_12.skeleton} />
      <skinnedMesh
        geometry={nodes.mesh_0_13.geometry}
        material={materials.Hammer}
        skeleton={nodes.mesh_0_13.skeleton}
      />
      <skinnedMesh geometry={nodes.mesh_0_14.geometry} material={materials.Chair} skeleton={nodes.mesh_0_14.skeleton} />
      <skinnedMesh
