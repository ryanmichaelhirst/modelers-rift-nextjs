...
type GLTFResult = GLTF & {
  ...
  materials: {
    ...
    HeadVFX: THREE.MeshBasicMaterial
    Crown: THREE.MeshBasicMaterial
    Cape: THREE.MeshBasicMaterial
    RecallCrown: THREE.MeshBasicMaterial
    BlackHole: THREE.MeshBasicMaterial
    RecallBlackHole: THREE.MeshBasicMaterial
  }
}
...
export default function Model(props: JSX.IntrinsicElements['group'] & { glb: any; timerLabel: string }) {
  ...
  return (
    <group ref={ref} {...props} dispose={null}>
      ...
      <skinnedMesh geometry={nodes.mesh_0_2.geometry} material={materials.roots} skeleton={nodes.mesh_0_2.skeleton} />
      <skinnedMesh geometry={nodes.mesh_0_3.geometry} material={materials.HeadVFX} skeleton={nodes.mesh_0_3.skeleton} />
      <skinnedMesh geometry={nodes.mesh_0_4.geometry} material={materials.Crown} skeleton={nodes.mesh_0_4.skeleton} />
      ...
      <skinnedMesh
        ...
        material={materials.RecallBlackHole}
