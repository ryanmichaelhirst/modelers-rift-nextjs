...
export default function Model(props: JSX.IntrinsicElements['group'] & { glb: any; timerLabel: string }) {
  ...
  return (
    <group ref={ref} {...props} dispose={null}>
      ...
      <skinnedMesh geometry={nodes.mesh_0.geometry} material={materials.Recall_Rock} skeleton={nodes.mesh_0.skeleton} />
      ...
      <skinnedMesh geometry={nodes.mesh_0_3.geometry} material={materials.Effect} skeleton={nodes.mesh_0_3.skeleton} />
    </group>
  )
}
