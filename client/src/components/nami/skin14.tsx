...
type GLTFResult = GLTF & {
  ...
  materials: {
    Nami_Skin09_MAT: THREE.MeshBasicMaterial
    Nami_Skin09_Tail_MAT: THREE.MeshBasicMaterial
  }
}
...
type ActionName =
  ...
  | 'nami_koi_spell2'
  | 'Spell3'
  | 'nami_skin09_idle_leadin2'
  | 'nami_skin09_idle_leadin3'
  | 'nami_skin09_idle4'
  | 'Spell4_Base'
  | 'nami_koi_idle1'
  | 'Recall_Winddown'
  ...
  return (
    <group ref={ref} {...props} dispose={null}>
      ...
      <skinnedMesh
        ...
        material={materials.Nami_Skin09_MAT}
        skeleton={nodes.mesh_0.skeleton}
      />
      <skinnedMesh
        geometry={nodes.mesh_0_1.geometry}
        material={materials.Nami_Skin09_Tail_MAT}
