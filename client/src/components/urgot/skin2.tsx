...
type GLTFResult = GLTF & {
  ...
  materials: {
    ...
    add_Urgot_Butcher_MAT2: THREE.MeshBasicMaterial
    add_Urgot_Butcher_MAT1: THREE.MeshBasicMaterial
  }
}
  ...
  return (
    <group ref={ref} {...props} dispose={null}>
      ...
      <skinnedMesh
        ...
        material={materials.add_Urgot_Butcher_MAT2}
        skeleton={nodes.mesh_0_1.skeleton}
      />
      <skinnedMesh
        geometry={nodes.mesh_0_2.geometry}
        material={materials.add_Urgot_Butcher_MAT1}
