...
type GLTFResult = GLTF & {
  ...
  materials: {
    GnarBig_Skin15_MAT: THREE.MeshBasicMaterial
    GnarBig_Rock_MAT: THREE.MeshBasicMaterial
...
const Model: FC<AnimatedModelProps> = memo(({ glbUrl, onSetAnimationMixer }) => {
  ...
  return (
    <group ref={ref} dispose={null}>
      ...
      <group position={[-160.07, -27.93, -155.76]} scale={0.02}>
        <skinnedMesh
          geometry={nodes.mesh_0.geometry}
          material={materials.GnarBig_Skin15_MAT}
          skeleton={nodes.mesh_0.skeleton}
        />
        <skinnedMesh
          geometry={nodes.mesh_0_1.geometry}
          material={materials.GnarBig_Rock_MAT}
