...
type GLTFResult = GLTF & {
  ...
  materials: {
    GnarBig_SuperGalaxy_MD_GnarBig_SuperGalaxy_MAT5: THREE.MeshBasicMaterial
    GnarBig_SPG_Drill_MAT: THREE.MeshBasicMaterial
  }
}
...
export default function Model(
  ...
  return (
    <group ref={ref} {...props} dispose={null}>
      ...
      <group position={[-176.87, -56.3, -172.95]} scale={0.02}>
        <skinnedMesh
          geometry={nodes.mesh_0.geometry}
          material={materials.GnarBig_SuperGalaxy_MD_GnarBig_SuperGalaxy_MAT5}
          skeleton={nodes.mesh_0.skeleton}
        />
        <skinnedMesh
          geometry={nodes.mesh_0_1.geometry}
          material={materials.GnarBig_SPG_Drill_MAT}
