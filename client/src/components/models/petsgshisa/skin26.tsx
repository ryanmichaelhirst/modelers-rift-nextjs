  ...
  return (
    <group ref={ref} dispose={null}>
      ...
      <group position={[-50.08, 0, -117.57]} scale={0.01}>
        ...
        />
        <skinnedMesh geometry={nodes.mesh_0_1.geometry} material={materials.Frame} skeleton={nodes.mesh_0_1.skeleton} />
        <skinnedMesh geometry={nodes.mesh_0_2.geometry} material={materials.Lens} skeleton={nodes.mesh_0_2.skeleton} />
      </group>
    </group>
  )
}, areEqual)
