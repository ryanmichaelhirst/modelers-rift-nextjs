  ...
  return (
    <group ref={ref} dispose={null}>
      <group scale={[-1, 1, 1]}>
        ...
        <primitive object={nodes.Map_Root} />
      </group>
      <group position={[-60.39, -1.15, -96.06]} scale={0.01}>
        ...
        />
        <skinnedMesh geometry={nodes.mesh_0_3.geometry} material={materials.Map} skeleton={nodes.mesh_0_3.skeleton} />
      </group>
    </group>
  )
}, areEqual)
