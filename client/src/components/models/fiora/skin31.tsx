...
type GLTFResult = GLTF & {
  nodes: {
    ...
    Recall_Weapon1: THREE.Bone
    Pedestal: THREE.Bone
    C_BUFFBONE_GLB_OVERHEAD_LOC: THREE.Bone
  }
  materials: {
    Fiora_IG_Mat: THREE.MeshBasicMaterial
  ...
  return (
    <group ref={ref} dispose={null}>
      <group scale={[-1, 1, 1]}>
        ...
        <primitive object={nodes.Recall_Weapon1} />
        <primitive object={nodes.Pedestal} />
        <primitive object={nodes.C_BUFFBONE_GLB_OVERHEAD_LOC} />
      </group>
      <group position={[-52.08, -51.95, -42.16]} scale={0.01}>
        <skinnedMesh
          geometry={nodes.mesh_0.geometry}
          material={materials.Fiora_IG_Mat}
