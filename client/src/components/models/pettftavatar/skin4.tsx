...
type GLTFResult = GLTF & {
  ...
  materials: {
    ...
    Journey: THREE.MeshBasicMaterial
  }
}
...
const Model: FC<AnimatedModelProps> = memo(({ glbUrl, onSetAnimationMixer }) => {
  ...
  return (
    <group ref={ref} dispose={null}>
      ...
      <group position={[-101.47, 68.6, -70.39]} scale={0.01}>
        <skinnedMesh geometry={nodes.mesh_0.geometry} material={materials.Eye1} skeleton={nodes.mesh_0.skeleton} />
        <skinnedMesh geometry={nodes.mesh_0_1.geometry} material={materials.Body} skeleton={nodes.mesh_0_1.skeleton} />
        <skinnedMesh
          geometry={nodes.mesh_0_2.geometry}
          material={materials.Journey}
