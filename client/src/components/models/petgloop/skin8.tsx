...
type GLTFResult = GLTF & {
  ...
  materials: {
    ...
    Face_Surprise: THREE.MeshBasicMaterial
    Hair3: THREE.MeshBasicMaterial
  }
}
    ...
    <group ref={ref} dispose={null}>
      ...
      <group position={[-61.25, 0, -58.84]} scale={0.01}>
        ...
        <skinnedMesh
          ...
          material={materials.Face_Surprise}
          skeleton={nodes.mesh_0_3.skeleton}
        />
        <skinnedMesh geometry={nodes.mesh_0_4.geometry} material={materials.Hair3} skeleton={nodes.mesh_0_4.skeleton} />
      </group>
    </group>
  )
}, areEqual)
