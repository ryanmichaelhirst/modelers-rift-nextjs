...
type GLTFResult = GLTF & {
  ...
  materials: {
    Zyra_Coven_Plant_Seed_MAT: THREE.MeshBasicMaterial
  }
}

type ActionName = 'Death' | 'Spawn' | 'zyraseed_skin05_idle'
  ...
  return (
    <group ref={ref} {...props} dispose={null}>
      ...
      <skinnedMesh
        ...
        material={materials.Zyra_Coven_Plant_Seed_MAT}
        skeleton={nodes.mesh_0.skeleton}
        position={[-37.04, -1.14, -41.7]}
        scale={0.01}
      />
    </group>
  )
