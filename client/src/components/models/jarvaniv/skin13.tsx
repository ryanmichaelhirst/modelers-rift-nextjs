...
type ActionName =
  ...
  | 'Spell6'
  | 'Taunt'
  | 'jarvaniv_recall.pie_c_10_13'
  | 'umbrella.pie_c_10_13'
...
const Model: FC<AnimatedModelProps> = memo(({ glbUrl, onSetAnimationMixer }) => {
  ...
  return (
    <group ref={ref} dispose={null}>
      ...
      <group position={[-82.66, -2.94, -124.74]} scale={0.02}>
        ...
        />
        <skinnedMesh geometry={nodes.mesh_0_2.geometry} material={materials.Crab} skeleton={nodes.mesh_0_2.skeleton} />
      </group>
    </group>
  )
}, areEqual)
