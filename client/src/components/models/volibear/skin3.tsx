...
type ActionName =
  ...
  | 'volibear_runeguard_attack1_to_run.voli'
  | 'volibear_runeguard_attack2_to_run.voli'
  | 'Spell4_Run'
  ...
  return (
    <group ref={ref} dispose={null}>
      <group scale={[-1, 1, 1]}>
        ...
        <primitive object={nodes.RuneA} />
        <primitive object={nodes.RuneB} />
        <primitive object={nodes.RuneC} />
        <primitive object={nodes.PoroA_Root} />
        <primitive object={nodes.PoroB_Root} />
        <primitive object={nodes.PoroC_Root} />
      </group>
      <group position={[-147.79, 0, -80.5]} scale={0.02}>
        <skinnedMesh
