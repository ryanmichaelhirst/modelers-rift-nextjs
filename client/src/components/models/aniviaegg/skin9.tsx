...
type GLTFResult = GLTF & {
  ...
  materials: {
    AniviaEgg_Skin08_MAT: THREE.MeshBasicMaterial
  }
}

type ActionName = 'Death' | 'Idle1' | 'anivia_rebirthegg_blackice_death2'
  ...
  return (
    <group ref={ref} dispose={null}>
      ...
      <skinnedMesh
        ...
        material={materials.AniviaEgg_Skin08_MAT}
        skeleton={nodes.mesh_0.skeleton}
        position={[-22.49, -4.87, -22.49]}
        scale={0}
      />
    </group>
  )
