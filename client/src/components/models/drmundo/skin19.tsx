  ...
  return (
    <group ref={ref} dispose={null}>
      ...
      <group position={[-466.42, -28.02, -86.12]} scale={0.04}>
        ...
        />
        <skinnedMesh geometry={nodes.mesh_0_2.geometry} material={materials.Car} skeleton={nodes.mesh_0_2.skeleton} />
        <skinnedMesh geometry={nodes.mesh_0_3.geometry} material={materials.Tie2} skeleton={nodes.mesh_0_3.skeleton} />
      </group>
    </group>
  )
}, areEqual)
