...
type GLTFResult = GLTF & {
  ...
  materials: {
    nautilus_submarine_MD_MAT_nautilus_submarine: THREE.MeshBasicMaterial
  }
}
  ...
  return (
    <group ref={ref} dispose={null}>
      ...
      <skinnedMesh
        ...
        material={materials.nautilus_submarine_MD_MAT_nautilus_submarine}
        skeleton={nodes.mesh_0.skeleton}
        position={[-385.93, 0.5, -50.98]}
        scale={0.03}
      />
    </group>
  )
