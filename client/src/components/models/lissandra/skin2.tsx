...
type GLTFResult = GLTF & {
  ...
  materials: {
    proxy_base_blinn2: THREE.MeshBasicMaterial
    Lissandra_Recall: THREE.MeshBasicMaterial
...
type ActionName =
  ...
  | 'lissandra_taunt'
  | 'Recall'
  | 'lissandra_skin02_recall_winddown'
  | 'Recall_Leadout'
  | 'Turn_L'
  | 'Turn_L180'
  | 'Turn_R'
...
const Model: FC<AnimatedModelProps> = memo(({ glbUrl, onSetAnimationMixer }) => {
  ...
  return (
    <group ref={ref} dispose={null}>
      ...
      <group position={[-88.41, -71.11, -192.99]} scale={0.02}>
        <skinnedMesh
          geometry={nodes.mesh_0.geometry}
          material={materials.proxy_base_blinn2}
          skeleton={nodes.mesh_0.skeleton}
        />
        <skinnedMesh
          geometry={nodes.mesh_0_1.geometry}
          material={materials.Lissandra_Recall}
