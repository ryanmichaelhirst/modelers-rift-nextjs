...
type GLTFResult = GLTF & {
  ...
  materials: {
    Fizz_Dog_MAT: THREE.MeshBasicMaterial
    Fizz_Skin14_MD_Fizz_Dog_MAT: THREE.MeshBasicMaterial
  ...
  return (
    <group ref={ref} {...props} dispose={null}>
      ...
      <skinnedMesh
        ...
        material={materials.Fizz_Dog_MAT}
        skeleton={nodes.mesh_0.skeleton}
      />
      <skinnedMesh
        geometry={nodes.mesh_0_1.geometry}
        material={materials.Fizz_Skin14_MD_Fizz_Dog_MAT}
