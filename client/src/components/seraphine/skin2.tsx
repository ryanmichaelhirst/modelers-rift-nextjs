...
type GLTFResult = GLTF & {
  nodes: {
    ...
    Panel01_Main: THREE.Bone
    Panel02_Main: THREE.Bone
    Panel03_Main: THREE.Bone
    Microphone_Main: THREE.Bone
    Phone: THREE.Bone
  ...
  materials: {
    ...
    Microphone_Mat: THREE.MeshBasicMaterial
    Sound_Panel_MAT: THREE.MeshBasicMaterial
    Hanging_Microphone_MAT: THREE.MeshBasicMaterial
    Phone_MAT: THREE.MeshBasicMaterial
    Headphone_MAT: THREE.MeshBasicMaterial
  }
}
...
type ActionName =
  ...
  | 'idle1.ellipsismage'
  | 'idle2.ellipsismage'
  | 'run_to_idle_ooc.ellipsismage'
  | 'idle_to_idle_ooc.ellipsismage'
  ...
  return (
    <group ref={ref} {...props} dispose={null}>
      <group scale={[-1, 1, 1]}>
        ...
        <primitive object={nodes.Panel01_Main} />
        <primitive object={nodes.Panel02_Main} />
        <primitive object={nodes.Panel03_Main} />
        <primitive object={nodes.Microphone_Main} />
      ...
      <skinnedMesh
        ...
        material={materials.Sound_Panel_MAT}
        skeleton={nodes.mesh_0_4.skeleton}
      />
      <skinnedMesh
        geometry={nodes.mesh_0_5.geometry}
        material={materials.Hanging_Microphone_MAT}
      ...
      <skinnedMesh
        ...
        material={materials.Headphone_MAT}
