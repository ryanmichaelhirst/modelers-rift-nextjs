...
type GLTFResult = GLTF & {
  ...
  materials: {
    ...
    Gems_Mat: THREE.MeshBasicMaterial
    ...
    Table_MAT: THREE.MeshBasicMaterial
    Guitar_MAT: THREE.MeshBasicMaterial
    Bed_MAT: THREE.MeshBasicMaterial
...
export default function Model(props: JSX.IntrinsicElements['group'] & { glb: any; timerLabel: string }) {
  ...
  return (
    <group ref={ref} {...props} dispose={null}>
      ...
      />
      <skinnedMesh geometry={nodes.mesh_0_9.geometry} material={materials.Bed_MAT} skeleton={nodes.mesh_0_9.skeleton} />
      <skinnedMesh
