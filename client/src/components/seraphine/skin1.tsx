...
type GLTFResult = GLTF & {
  ...
  materials: {
    ...
    Guitar_MAT: THREE.MeshBasicMaterial
...
type ActionName =
  ...
  | 'Idle1_Base'
  | 'idle.ellipsismage'
  | 'idle_var1.ellipsismage'
  | 'idle_in_ooc.ellipsismage'
  | 'run_homegaurd_to_ooc_idle.ellipsismage'
  | 'idle_to_idle_ooc.ellipsismage'
  | 'idle_var2.ellipsismage'
