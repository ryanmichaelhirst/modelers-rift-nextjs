...
type ActionName =
  ...
  | 'Spell4_Windup'
  | 'Taunt'
  | 'missfortune_skin20_spell4_to_idle'
  | 'Idle_In'
  | 'Idle2_Base'
  | 'Spell4_Loop'
  | 'Recall'
...
export default function Model(props: JSX.IntrinsicElements['group'] & { glb: any; timerLabel: string }) {
  ...
  return (
    <group ref={ref} {...props} dispose={null}>
      ...
      />
      <skinnedMesh geometry={nodes.mesh_0_1.geometry} material={materials.Pumpkin} skeleton={nodes.mesh_0_1.skeleton} />
    </group>
  )
}
