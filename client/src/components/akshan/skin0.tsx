...
type GLTFResult = GLTF & {
  ...
  materials: {
    ...
    Hood_Hair: THREE.MeshBasicMaterial
...
type ActionName =
  ...
  | 'base_attack2_from_base_attack1.akshan'
  | 'base_attack2_to_run.akshan'
  | 'Attack2_To_Idle'
  | 'Stunned'
  | 'taunt_cycle.akshan'
  | 'spell1_catch.akshan'
...
export default function Model(props: JSX.IntrinsicElements['group'] & { glb: any; timerLabel: string }) {
  ...
  return (
    <group ref={ref} {...props} dispose={null}>
      ...
      <skinnedMesh geometry={nodes.mesh_0_2.geometry} material={materials.Hood} skeleton={nodes.mesh_0_2.skeleton} />
      <skinnedMesh
        geometry={nodes.mesh_0_3.geometry}
        material={materials.Hood_Hair}
        skeleton={nodes.mesh_0_3.skeleton}
      />
      <skinnedMesh geometry={nodes.mesh_0_4.geometry} material={materials.Weapon} skeleton={nodes.mesh_0_4.skeleton} />
      <skinnedMesh geometry={nodes.mesh_0_5.geometry} material={materials.Hook} skeleton={nodes.mesh_0_5.skeleton} />
      <skinnedMesh
        geometry={nodes.mesh_0_6.geometry}
        material={materials.Boomerang}
        skeleton={nodes.mesh_0_6.skeleton}
      />
      <skinnedMesh geometry={nodes.mesh_0_7.geometry} material={materials.Rope} skeleton={nodes.mesh_0_7.skeleton} />
    </group>
  )
}
