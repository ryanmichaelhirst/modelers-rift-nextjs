...
type GLTFResult = GLTF & {
  ...
  materials: {
    ...
    Small_Spikes: THREE.MeshBasicMaterial
    Body: THREE.MeshBasicMaterial
    Small_Sword: THREE.MeshBasicMaterial
    Small_Sword_Blade: THREE.MeshBasicMaterial
    HeadB: THREE.MeshBasicMaterial
    HeadA: THREE.MeshBasicMaterial
    Spikes: THREE.MeshBasicMaterial
    FireBro: THREE.MeshBasicMaterial
    FireBro2: THREE.MeshBasicMaterial
    FireBro3: THREE.MeshBasicMaterial
    FireBro4: THREE.MeshBasicMaterial
  }
}
...
export default function Model(props: JSX.IntrinsicElements['group'] & { glb: any; timerLabel: string }) {
  ...
  return (
    <group ref={ref} {...props} dispose={null}>
      ...
      <skinnedMesh geometry={nodes.mesh_0.geometry} material={materials.Big_Sword} skeleton={nodes.mesh_0.skeleton} />
      <skinnedMesh
      ...
      <skinnedMesh
        ...
        material={materials.Small_Spikes}
        skeleton={nodes.mesh_0_2.skeleton}
      />
      <skinnedMesh geometry={nodes.mesh_0_3.geometry} material={materials.Body} skeleton={nodes.mesh_0_3.skeleton} />
      <skinnedMesh
        geometry={nodes.mesh_0_4.geometry}
        material={materials.Small_Sword}
        skeleton={nodes.mesh_0_4.skeleton}
      />
      <skinnedMesh
        geometry={nodes.mesh_0_5.geometry}
        material={materials.Small_Sword_Blade}
        skeleton={nodes.mesh_0_5.skeleton}
      />
      <skinnedMesh geometry={nodes.mesh_0_6.geometry} material={materials.HeadB} skeleton={nodes.mesh_0_6.skeleton} />
      <skinnedMesh geometry={nodes.mesh_0_7.geometry} material={materials.HeadA} skeleton={nodes.mesh_0_7.skeleton} />
      <skinnedMesh geometry={nodes.mesh_0_8.geometry} material={materials.Spikes} skeleton={nodes.mesh_0_8.skeleton} />
      <skinnedMesh geometry={nodes.mesh_0_9.geometry} material={materials.FireBro} skeleton={nodes.mesh_0_9.skeleton} />
      <skinnedMesh
        geometry={nodes.mesh_0_10.geometry}
        material={materials.FireBro2}
        skeleton={nodes.mesh_0_10.skeleton}
      />
      <skinnedMesh
        geometry={nodes.mesh_0_11.geometry}
        material={materials.FireBro3}
        skeleton={nodes.mesh_0_11.skeleton}
      />
      <skinnedMesh
        geometry={nodes.mesh_0_12.geometry}
        material={materials.FireBro4}
