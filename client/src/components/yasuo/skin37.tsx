...
export default function Model(props: JSX.IntrinsicElements['group'] & { glb: any; timerLabel: string }) {
  ...
  return (
    <group ref={ref} {...props} dispose={null}>
      ...
      <skinnedMesh geometry={nodes.mesh_0_1.geometry} material={materials.Sword} skeleton={nodes.mesh_0_1.skeleton} />
      <skinnedMesh geometry={nodes.mesh_0_2.geometry} material={materials.Armband} skeleton={nodes.mesh_0_2.skeleton} />
      ...
      />
      <skinnedMesh geometry={nodes.mesh_0_6.geometry} material={materials.Tree} skeleton={nodes.mesh_0_6.skeleton} />
