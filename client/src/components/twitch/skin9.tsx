...
type GLTFResult = GLTF & {
  ...
  materials: {
    Twitch_Skin08_MD_Twitch_OmegaSquad_MAT: THREE.MeshBasicMaterial
    Recall_Rope: THREE.MeshBasicMaterial
    Recall_OS: THREE.MeshBasicMaterial
  ...
  return (
    <group ref={ref} {...props} dispose={null}>
      <group scale={[-1, 1, 1]}>
        ...
        <primitive object={nodes.Flare} />
      </group>
      <skinnedMesh
        geometry={nodes.mesh_0.geometry}
        material={materials.Twitch_Skin08_MD_Twitch_OmegaSquad_MAT}
