...
type GLTFResult = GLTF & {
  ...
  materials: {
    RebirthEgg_: THREE.MeshBasicMaterial
  }
}

type ActionName = 'Death' | 'Idle1'
...
export default function Model(props: JSX.IntrinsicElements['group'] & { glb: any; timerLabel: string }) {
  ...
  return (
    <group ref={ref} {...props} dispose={null}>
      ...
      <skinnedMesh geometry={nodes.mesh_0.geometry} material={materials.RebirthEgg_} skeleton={nodes.mesh_0.skeleton} />
    </group>
  )
}
