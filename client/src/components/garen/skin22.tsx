...
type GLTFResult = GLTF & {
  ...
  materials: {
    ...
    GarenMecha_ShoulderPads_MAT: THREE.MeshBasicMaterial
    GarenMecha_Weapon_MAT: THREE.MeshBasicMaterial
    GarenMecha_Wings_MAT: THREE.MeshBasicMaterial
  }
}
  ...
  return (
    <group ref={ref} {...props} dispose={null}>
      ...
      <skinnedMesh
        ...
        material={materials.GarenMecha_ShoulderPads_MAT}
        skeleton={nodes.mesh_0_1.skeleton}
      />
      <skinnedMesh
        geometry={nodes.mesh_0_2.geometry}
        material={materials.GarenMecha_Weapon_MAT}
        skeleton={nodes.mesh_0_2.skeleton}
      />
      <skinnedMesh
        geometry={nodes.mesh_0_3.geometry}
        material={materials.GarenMecha_Wings_MAT}
