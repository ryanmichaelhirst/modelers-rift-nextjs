...
type GLTFResult = GLTF & {
  ...
  materials: {
    udyr_spiritSummoner_maxtiger_MD_lambert5: THREE.MeshBasicMaterial
    udyr_spiritSummoner_maxtiger_MD_ubyr_base_mat_alpha1: THREE.MeshBasicMaterial
  }
}
  ...
  return (
    <group ref={ref} {...props} dispose={null}>
      ...
      <skinnedMesh
        ...
        material={materials.udyr_spiritSummoner_maxtiger_MD_lambert5}
        skeleton={nodes.mesh_0.skeleton}
      />
      <skinnedMesh
        geometry={nodes.mesh_0_1.geometry}
        material={materials.udyr_spiritSummoner_maxtiger_MD_ubyr_base_mat_alpha1}
