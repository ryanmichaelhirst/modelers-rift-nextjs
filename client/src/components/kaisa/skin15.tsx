...
type GLTFResult = GLTF & {
  ...
  materials: {
    Kaisa_Skin15_Mat: THREE.MeshBasicMaterial
    Kaisa_Skin15_Gold_Mat: THREE.MeshBasicMaterial
  ...
  return (
    <group ref={ref} {...props} dispose={null}>
      ...
      <skinnedMesh
        ...
        material={materials.Kaisa_Skin15_Mat}
        skeleton={nodes.mesh_0.skeleton}
      />
      <skinnedMesh
        geometry={nodes.mesh_0_1.geometry}
        material={materials.Kaisa_Skin15_Gold_Mat}
