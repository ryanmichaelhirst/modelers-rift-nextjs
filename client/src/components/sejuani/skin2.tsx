...
type GLTFResult = GLTF & {
  ...
  materials: {
    death_knight_shader: THREE.MeshBasicMaterial
    death_knight_shader1: THREE.MeshBasicMaterial
  }
}
  ...
  return (
    <group ref={ref} {...props} dispose={null}>
      ...
      <skinnedMesh
        ...
        material={materials.death_knight_shader}
        skeleton={nodes.mesh_0.skeleton}
      />
      <skinnedMesh
        geometry={nodes.mesh_0_1.geometry}
        material={materials.death_knight_shader1}
