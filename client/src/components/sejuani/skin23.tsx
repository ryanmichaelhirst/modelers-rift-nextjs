...
export default function Model(props: JSX.IntrinsicElements['group'] & { glb: any; timerLabel: string }) {
  ...
  return (
    <group ref={ref} {...props} dispose={null}>
      ...
      />
      <skinnedMesh geometry={nodes.mesh_0_2.geometry} material={materials.Bristle} skeleton={nodes.mesh_0_2.skeleton} />
      <skinnedMesh
      ...
      />
      <skinnedMesh geometry={nodes.mesh_0_6.geometry} material={materials.CityRed} skeleton={nodes.mesh_0_6.skeleton} />
      <skinnedMesh
