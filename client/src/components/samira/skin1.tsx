...
type GLTFResult = GLTF & {
  ...
  materials: {
    ...
    Diamond: THREE.MeshBasicMaterial
  }
}
...
export default function Model(props: JSX.IntrinsicElements['group'] & { glb: any; timerLabel: string }) {
  ...
  return (
    <group ref={ref} {...props} dispose={null}>
      ...
      <skinnedMesh geometry={nodes.mesh_0.geometry} material={materials.Sword} skeleton={nodes.mesh_0.skeleton} />
      <skinnedMesh
        geometry={nodes.mesh_0_1.geometry}
        material={materials.Revolver}
        skeleton={nodes.mesh_0_1.skeleton}
      />
      <skinnedMesh geometry={nodes.mesh_0_2.geometry} material={materials.Pistol} skeleton={nodes.mesh_0_2.skeleton} />
      <skinnedMesh
      ...
      <skinnedMesh geometry={nodes.mesh_0_7.geometry} material={materials.Coin} skeleton={nodes.mesh_0_7.skeleton} />
      <skinnedMesh geometry={nodes.mesh_0_8.geometry} material={materials.Diamond} skeleton={nodes.mesh_0_8.skeleton} />
    </group>
  )
}
