...
export default function Model(props: JSX.IntrinsicElements['group'] & { glb: any; timerLabel: string }) {
  ...
  return (
    <group ref={ref} {...props} dispose={null}>
      ...
      <skinnedMesh geometry={nodes.mesh_0.geometry} material={materials.Pistol} skeleton={nodes.mesh_0.skeleton} />
      <skinnedMesh
      ...
      <skinnedMesh geometry={nodes.mesh_0_6.geometry} material={materials.Coin} skeleton={nodes.mesh_0_6.skeleton} />
    </group>
  )
}
