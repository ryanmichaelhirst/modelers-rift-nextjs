...
type GLTFResult = GLTF & {
  ...
  materials: {
    Galio_Gatekeeper_MAT: THREE.MeshBasicMaterial
    Skin04Wings_VFX: THREE.MeshBasicMaterial
  }
}
...
type ActionName =
  ...
  | 'Run_Haste'
  | 'Spell1_To_Run'
  | 'galio_gatekeeper_spell2_idle'
  | 'galio_gatekeeper_spell2_run'
  | 'Spell2_Idle_Cast'
  | 'Spell2_Run_Cast'
  | 'Spell2_TRA'
  | 'Spell3_Hit'
  ...
  return (
    <group ref={ref} {...props} dispose={null}>
      ...
      <skinnedMesh
        ...
        material={materials.Galio_Gatekeeper_MAT}
        skeleton={nodes.mesh_0.skeleton}
      />
      <skinnedMesh
        geometry={nodes.mesh_0_1.geometry}
        material={materials.Skin04Wings_VFX}
