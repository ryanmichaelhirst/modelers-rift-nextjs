...
type GLTFResult = GLTF & {
  ...
  materials: {
    Skin03_MAT: THREE.MeshBasicMaterial
    Skin03Wings_VFX: THREE.MeshBasicMaterial
  }
}
...
export default function Model(props: JSX.IntrinsicElements['group'] & { glb: any; timerLabel: string }) {
  ...
  return (
    <group ref={ref} {...props} dispose={null}>
      ...
      <skinnedMesh geometry={nodes.mesh_0.geometry} material={materials.Skin03_MAT} skeleton={nodes.mesh_0.skeleton} />
      <skinnedMesh
        geometry={nodes.mesh_0_1.geometry}
        material={materials.Skin03Wings_VFX}
