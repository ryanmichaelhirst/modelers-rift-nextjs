...
export default function Model(props: JSX.IntrinsicElements['group'] & { glb: any; timerLabel: string }) {
  ...
  return (
    <group ref={ref} {...props} dispose={null}>
      ...
      <skinnedMesh geometry={nodes.mesh_0.geometry} material={materials.BarrelBlue} skeleton={nodes.mesh_0.skeleton} />
      <skinnedMesh
      ...
      <skinnedMesh geometry={nodes.mesh_0_4.geometry} material={materials.Recall1} skeleton={nodes.mesh_0_4.skeleton} />
    </group>
  )
}
