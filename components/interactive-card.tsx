  ...
  return (
    <GlassCard classes='flex flex-col h-full' hasPadding={false}>
      ...
      <div className='flex-auto'>
        <GlassCard classes='bg-white/70 rounded-t-lg p-4' hasPadding={false} rounded={false}>
          <div style={{ color: '#FF6BD0', backgroundColor: '$#FECFEF' }}>Audios</div>
          <table className='h-5/6 overflow-auto'>
            <thead>
              <tr>
                <td>#</td>
                <td>Title</td>
        ...
        <div className='rounded-b-lg bg-white h-1/6 flex items-center justify-start'>
          <div>
            <IconButton>
              <HeadphonesOutlined />
            </IconButton>
