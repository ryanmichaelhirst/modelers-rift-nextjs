...
type GLTFResult = GLTF & {
  ...
  materials: {
    Chaos_Minion_Siege_Starguardian_Red_Skin08_mat: THREE.MeshBasicMaterial
  }
}
  ...
  return (
    <group ref={ref} dispose={null}>
      ...
      <skinnedMesh
        ...
        material={materials.Chaos_Minion_Siege_Starguardian_Red_Skin08_mat}
        skeleton={nodes.mesh_0.skeleton}
        position={[-72, -2.85, -112.03]}
        scale={0.01}
      />
    </group>
  )
