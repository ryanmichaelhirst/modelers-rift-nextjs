...
type GLTFResult = GLTF & {
  ...
  materials: {
    Zyra_GraspingPlant_MAT: THREE.MeshBasicMaterial
  }
}

type ActionName = 'Attack1' | 'Death' | 'Idle1' | 'Attack2' | 'Up'
  ...
  return (
    <group ref={ref} dispose={null}>
      ...
      <skinnedMesh
        ...
        material={materials.Zyra_GraspingPlant_MAT}
        skeleton={nodes.mesh_0.skeleton}
        position={[-33.11, -3.63, -33.57]}
        scale={0.02}
      />
    </group>
  )
