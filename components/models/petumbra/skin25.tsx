...
type GLTFResult = GLTF & {
  ...
  materials: {
    ...
    Cooked_Fish: THREE.MeshBasicMaterial
...
const Model: FC<AnimatedModelProps> = memo(({ glbUrl, onSetAnimationMixer }) => {
  ...
  return (
    <group ref={ref} dispose={null}>
      ...
      <group position={[-102.17, -40.78, -177.76]} scale={0.01}>
        ...
        <skinnedMesh
          ...
          material={materials.Cooked_Fish}
          skeleton={nodes.mesh_0_2.skeleton}
        />
        <skinnedMesh geometry={nodes.mesh_0_3.geometry} material={materials.Egg} skeleton={nodes.mesh_0_3.skeleton} />
        <skinnedMesh
