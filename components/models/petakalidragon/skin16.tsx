  ...
  return (
    <group ref={ref} dispose={null}>
      ...
      <group position={[-34.06, -0.32, -54.37]} scale={0.01}>
        <skinnedMesh geometry={nodes.mesh_0.geometry} material={materials.Wide} skeleton={nodes.mesh_0.skeleton} />
        <skinnedMesh geometry={nodes.mesh_0_1.geometry} material={materials.Anger} skeleton={nodes.mesh_0_1.skeleton} />
        <skinnedMesh
