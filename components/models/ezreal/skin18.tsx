...
type GLTFResult = GLTF & {
  nodes: {
    ...
    PetRoot: THREE.Bone
    C_Buffbone_Cstm_L_Wing: THREE.Bone
    C_Buffbone_Cstm_R_Wing: THREE.Bone
  }
  materials: {
    Ezreal_Skin18_Mat: THREE.MeshBasicMaterial
  ...
  return (
    <group ref={ref} dispose={null}>
      <group scale={[-1, 1, 1]}>
        ...
        <primitive object={nodes.C_Buffbone_Cstm_L_Wing} />
        <primitive object={nodes.C_Buffbone_Cstm_R_Wing} />
      </group>
      <group position={[-83.82, -53.22, -106.31]} scale={0.02}>
        <skinnedMesh
          geometry={nodes.mesh_0.geometry}
          material={materials.Ezreal_Skin18_Mat}
        ...
        />
        <skinnedMesh geometry={nodes.mesh_0_2.geometry} material={materials.Pet} skeleton={nodes.mesh_0_2.skeleton} />
      </group>
    </group>
  )
}, areEqual)
