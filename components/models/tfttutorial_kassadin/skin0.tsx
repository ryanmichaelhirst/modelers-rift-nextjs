...
type GLTFResult = GLTF & {
  ...
  materials: {
    Kassadin_Mat: THREE.MeshBasicMaterial
  }
}

type ActionName = 'Attack1' | 'Attack2' | 'Crit' | 'Death' | 'Run' | 'Idle1' | 'Spell3' | 'Celebration'
  ...
  return (
    <group ref={ref} dispose={null}>
      ...
      <skinnedMesh
        ...
        material={materials.Kassadin_Mat}
        skeleton={nodes.mesh_0.skeleton}
        position={[-106.73, -18.23, -82.82]}
        scale={0.01}
      />
    </group>
  )
