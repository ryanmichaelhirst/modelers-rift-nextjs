...
type GLTFResult = GLTF & {
  ...
  materials: {
    udyr_spiritSummoner_maxphoenix_MD_blinn5SG5: THREE.MeshBasicMaterial
  }
}
  ...
  return (
    <group ref={ref} dispose={null}>
      ...
      <skinnedMesh
        ...
        material={materials.udyr_spiritSummoner_maxphoenix_MD_blinn5SG5}
        skeleton={nodes.mesh_0.skeleton}
        position={[-112.33, -0.59, -73.3]}
        scale={0.01}
      />
    </group>
  )
