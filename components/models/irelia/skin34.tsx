...
type GLTFResult = GLTF & {
  nodes: {
    ...
    Recall_Stone_Root: THREE.Bone
  }
  materials: {
    Body_MAT: THREE.MeshBasicMaterial
    blades: THREE.MeshBasicMaterial
    RecallRock: THREE.MeshBasicMaterial
  }
}
...
type ActionName =
  ...
  | 'Attack1_To_Idle'
  | 'attack_01_windmillkick.pie_c_11_14'
  ...
  return (
    <group ref={ref} dispose={null}>
      <group scale={[-1, 1, 1]}>
        ...
        <primitive object={nodes.Recall_Stone_Root} />
      </group>
      <group position={[-95.05, -5.56, -135.9]} scale={0.01}>
