...
type GLTFResult = GLTF & {
  ...
  materials: {
    Order_Minion_Caster_Starguardian_Blue_Skin08_mat: THREE.MeshBasicMaterial
  }
}
  ...
  return (
    <group ref={ref} dispose={null}>
      ...
      <skinnedMesh
        ...
        material={materials.Order_Minion_Caster_Starguardian_Blue_Skin08_mat}
        skeleton={nodes.mesh_0.skeleton}
        position={[-100.47, 7.2, -66.1]}
        scale={0.01}
      />
    </group>
  )
