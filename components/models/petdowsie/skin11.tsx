...
type GLTFResult = GLTF & {
  ...
  materials: {
    ...
    FaceShapes07: THREE.MeshBasicMaterial
...
const Model: FC<AnimatedModelProps> = memo(({ glbUrl, onSetAnimationMixer }) => {
  ...
  return (
    <group ref={ref} dispose={null}>
      ...
      <group position={[-358.06, -10, -98.15]} scale={0.03}>
        ...
        <skinnedMesh
          ...
          material={materials.FaceShapes07}
        ...
        />
        <skinnedMesh geometry={nodes.mesh_0_4.geometry} material={materials.Ball} skeleton={nodes.mesh_0_4.skeleton} />
        <skinnedMesh
