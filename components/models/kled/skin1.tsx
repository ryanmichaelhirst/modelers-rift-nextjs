...
type GLTFResult = GLTF & {
  ...
  materials: {
    KledMount_Skin01_Mat: THREE.MeshBasicMaterial
    KledRider_skin01_mat: THREE.MeshBasicMaterial
  }
}
...
const Model: FC<AnimatedModelProps> = memo(({ glbUrl, onSetAnimationMixer }) => {
  ...
  return (
    <group ref={ref} dispose={null}>
      ...
      <group position={[-104.19, -12.37, -137.49]} scale={0.02}>
        <skinnedMesh
          geometry={nodes.mesh_0.geometry}
          material={materials.KledMount_Skin01_Mat}
          skeleton={nodes.mesh_0.skeleton}
        />
        <skinnedMesh
          geometry={nodes.mesh_0_1.geometry}
          material={materials.KledRider_skin01_mat}
