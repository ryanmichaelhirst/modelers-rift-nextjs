...
type GLTFResult = GLTF & {
  ...
  materials: {
    ...
    HairProp_2: THREE.MeshBasicMaterial
    ...
    <group ref={ref} dispose={null}>
      ...
      <group position={[-182.6, -38.89, -110.07]} scale={0.02}>
        ...
        <skinnedMesh
          ...
          material={materials.HairProp_2}
          skeleton={nodes.mesh_0_3.skeleton}
        />
        <skinnedMesh geometry={nodes.mesh_0_4.geometry} material={materials.Cliff} skeleton={nodes.mesh_0_4.skeleton} />
      </group>
    </group>
  )
}, areEqual)
